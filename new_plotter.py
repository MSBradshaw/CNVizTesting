...
def plot_other_samples_calls(_ax: plt.Axes, _ax_legend: plt.Axes, _region: utils.Interval, _files: str, _sample_id: str,
...
def main():
    ...
    """
    plot_other_samples_calls(_ax=ax2, _ax_legend=ax2_legend, _region=target_window, _files=args.calls,
